...
ModelFactoryK80PIP::ModelFactoryK80PIP(double mu,double lambda,double k){
   ...
   double num=0;
   for(int i=0;i<4;i++){
	   num += (this->freqs_PIP(i)*(this->Q_PIP(i,i)+mu));
   }

   score_t norm_fact=-num;
